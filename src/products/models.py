...
class Product(models.Model):
    ...
    price = models.DecimalField(default=0.00, max_digits=33, decimal_places=28)
    vat_rate = models.DecimalField(default=0.00, max_digits=33, decimal_places=28, choices=VAT_RATE)
